...
#include "mojo/services/device_info/interfaces/device_info.mojom-sync.h"
...
DeviceInfo_SynchronousProxy::DeviceInfo_SynchronousProxy(
...
bool DeviceInfo_SynchronousProxy::GetDeviceType(DeviceInfo::DeviceType* out_device_type) {
  size_t size = sizeof(internal::DeviceInfo_GetDeviceType_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::DeviceInfo_Base::MessageOrdinals::GetDeviceType);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::DeviceInfo_GetDeviceType_Params_Data* out_params =
  ...
  internal::DeviceInfo_GetDeviceType_ResponseParams_Data*
      response_params = reinterpret_cast<internal::DeviceInfo_GetDeviceType_ResponseParams_Data*>(
  ...
  do {
    ...
    (*out_device_type) = static_cast<DeviceInfo::DeviceType>(response_params->device_type);
  } while (false);
  return true;
}
}  // namespace mojo
