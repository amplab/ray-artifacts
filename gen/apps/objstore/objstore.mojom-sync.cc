...
ObjStore_SynchronousProxy::ObjStore_SynchronousProxy(
...
bool ObjStore_SynchronousProxy::BuildObject(int64_t in_object_id, int64_t in_size, mojo::ScopedSharedBufferHandle* out_buffer) {
  size_t size = sizeof(internal::ObjStore_BuildObject_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::ObjStore_Base::MessageOrdinals::BuildObject);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::ObjStore_BuildObject_Params_Data* out_params =
  ...
  internal::ObjStore_BuildObject_ResponseParams_Data*
      response_params = reinterpret_cast<internal::ObjStore_BuildObject_ResponseParams_Data*>(
