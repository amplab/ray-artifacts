...
static struct MojomPointerTableArrayEntry mojo_URLRequest_16_0__PointerEntry;
static struct MojomPointerTableArrayEntry mojo_URLRequest_24_1__PointerEntry;
// Declarations for struct type tables.
struct MojomPointerTableStructEntry mojo_URLRequest__PointerTable[];
...
struct MojomPointerTableStructEntry mojo_URLRequest__PointerTable[] = {
  ...
  {
    &mojo_URLRequest_16_0__PointerEntry, 16, 0,
    MOJOM_ELEMENT_TYPE_ARRAY, true, true,
  },

  {
    &mojo_URLRequest_24_1__PointerEntry, 24, 0,
