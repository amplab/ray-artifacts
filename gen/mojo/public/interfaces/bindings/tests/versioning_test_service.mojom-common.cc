...
// static
Date_Data* Date_Data::New(mojo::internal::Buffer* buf) {
  return new (buf->Allocate(sizeof(Date_Data))) Date_Data();
}

// static
mojo::internal::ValidationError Date_Data::Validate(
    const void* data,
  ...
  const Date_Data* object = static_cast<const Date_Data*>(data);
...
void Date_Data::EncodePointersAndHandles(
    std::vector<mojo::Handle>* handles) {
  MOJO_CHECK(header_.version == 0);
}

void Date_Data::DecodePointersAndHandles(
    std::vector<mojo::Handle>* handles) {
...
mojo::internal::ValidationError Employee_Data::Validate(
  ...
  if (!mojo::internal::ValidateEncodedPointer(&object->birthday.offset)) {
    MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err) << "";
    return mojo::internal::ValidationError::ILLEGAL_POINTER;
  }
  auto validate_retval = Date::Data_::Validate(
          mojo::internal::DecodePointerRaw(&object->birthday.offset),
          bounds_checker, err);
  if (validate_retval != mojo::internal::ValidationError::NONE) {
    return validate_retval;
  }
...
void Employee_Data::EncodePointersAndHandles(
  ...
  mojo::internal::Encode(&this->birthday, handles);
}
...
void Employee_Data::DecodePointersAndHandles(
  ...
  if (header_.version < 1)
    return;
  mojo::internal::Decode(&this->birthday, handles);
}
...
DatePtr Date::New() {
  DatePtr rv;
  mojo::internal::StructHelper<Date>::Initialize(&rv);
  return rv;
}
...
bool Date::Equals(const Date& other) const {
  if (!mojo::internal::ValueTraits<uint16_t>::Equals(this->year, other.year))
    return false;
  if (!mojo::internal::ValueTraits<uint8_t>::Equals(this->month, other.month))
    return false;
  if (!mojo::internal::ValueTraits<uint8_t>::Equals(this->day, other.day))
    return false;
  return true;
}
...
bool Employee::Equals(const Employee& other) const {
  ...
  if (!mojo::internal::ValueTraits<Department>::Equals(this->department, other.department))
    return false;
  if (!mojo::internal::ValueTraits<DatePtr>::Equals(this->birthday, other.birthday))
    return false;
  return true;
}
...
size_t Date::GetSerializedSize() const {
  return GetSerializedSize_(*this);
}

bool Date::Serialize(void* buf,
                                size_t buf_size,
...
bool Date::Deserialize(void* buf, size_t buf_size) {
  MOJO_DCHECK(buf);
  ...
  mojo::internal::ValidationError err =
      internal::Date_Data::Validate(buf, &checker, err_str);
  if (err != mojo::internal::ValidationError::NONE) {
...
// immutable.
void Date::DeserializeWithoutValidation(void* buf) {
  MOJO_DCHECK(buf);

  internal::Date_Data* input =
      static_cast<internal::Date_Data*>(buf);
  std::vector<mojo::Handle> handles;
...
size_t GetSerializedSize_(const Date& input) {
  size_t size = sizeof(internal::Date_Data);
  return size;
}
...
mojo::internal::ValidationError Serialize_(
    ...
    internal::Date_Data** output) {
  if (input) {
    internal::Date_Data* result =
        internal::Date_Data::New(buf);
...
void Deserialize_(internal::Date_Data* input,
                  Date* result) {
  if (input) {
    do {
...
size_t GetSerializedSize_(const Employee& input) {
  ...
  size += input.birthday.is_null()
              ? 0
              : GetSerializedSize_(*input.birthday);
  return size;
}
...
mojo::internal::ValidationError Serialize_(
  ...
  if (input) {
    ...
    {auto retval =Serialize_(input->birthday.get(),
                 buf,
                 &result->birthday.ptr);
      if (retval != mojo::internal::ValidationError::NONE)
        return retval;
  ...
  if (input) {
    do {
      ...
      if (input->header_.version < 1)
        break;
      if (input->birthday.ptr) {
        result->birthday = Date::New();
        Deserialize_(input->birthday.ptr, result->birthday.get());
      }
    } while (false);
  }
}
