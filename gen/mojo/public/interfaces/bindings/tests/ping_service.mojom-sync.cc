...
#include "mojo/public/interfaces/bindings/tests/ping_service.mojom-sync.h"
...
PingService_SynchronousProxy::PingService_SynchronousProxy(
...
bool PingService_SynchronousProxy::Ping() {
  size_t size = sizeof(internal::PingService_Ping_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::PingService_Base::MessageOrdinals::Ping);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::PingService_Ping_Params_Data* out_params =
  ...
  internal::PingService_Ping_ResponseParams_Data*
      response_params = reinterpret_cast<internal::PingService_Ping_ResponseParams_Data*>(
