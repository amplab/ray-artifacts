...
#ifndef MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_VERSIONING_TEST_SERVICE_MOJOM_COMMON_H_
#define MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_VERSIONING_TEST_SERVICE_MOJOM_COMMON_H_
...
using DatePtr = mojo::InlinedStructPtr<Date>;
...
class HumanResourceDatabase_Base {
 public:
  ...
  static const uint32_t Version_ = 1;
...
namespace internal {
template <>
struct WrapperTraits<mojo::test::versioning::DatePtr, true, false> {
  using DataType = mojo::test::versioning::internal::Date_Data*;
};
template <>
...
class Date {
 public:
  using Data_ = internal::Date_Data;

  static DatePtr New();

  template <typename U>
  static DatePtr From(const U& u) {
    return mojo::TypeConverter<DatePtr, U>::Convert(u);
  }

  template <typename U>
  U To() const {
    return mojo::TypeConverter<U, Date>::Convert(*this);
  }
...
#endif  // MOJO_PUBLIC_INTERFACES_BINDINGS_TESTS_VERSIONING_TEST_SERVICE_MOJOM_COMMON_H_
