...
Calculator_SynchronousProxy::Calculator_SynchronousProxy(
...
bool Calculator_SynchronousProxy::Clear(double* out_value) {
  size_t size = sizeof(internal::Calculator_Clear_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::Calculator_Base::MessageOrdinals::Clear);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::Calculator_Clear_Params_Data* out_params =
  ...
  internal::Calculator_Clear_ResponseParams_Data*
      response_params = reinterpret_cast<internal::Calculator_Clear_ResponseParams_Data*>(
...
bool Calculator_SynchronousProxy::Add(double in_value, double* out_value) {
  size_t size = sizeof(internal::Calculator_Add_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::Calculator_Base::MessageOrdinals::Add);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::Calculator_Add_Params_Data* out_params =
      internal::Calculator_Add_Params_Data::New(builder.buffer());
  out_params->value = in_value;
  out_params->EncodePointersAndHandles(builder.message()->mutable_handles());
  ...
  internal::Calculator_Add_ResponseParams_Data*
      response_params = reinterpret_cast<internal::Calculator_Add_ResponseParams_Data*>(
          response_msg.mutable_payload());
  response_params->DecodePointersAndHandles(response_msg.mutable_handles());
...
bool Calculator_SynchronousProxy::Multiply(double in_value, double* out_value) {
  size_t size = sizeof(internal::Calculator_Multiply_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::Calculator_Base::MessageOrdinals::Multiply);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::Calculator_Multiply_Params_Data* out_params =
  ...
  internal::Calculator_Multiply_ResponseParams_Data*
      response_params = reinterpret_cast<internal::Calculator_Multiply_ResponseParams_Data*>(
          response_msg.mutable_payload());
  response_params->DecodePointersAndHandles(response_msg.mutable_handles());
