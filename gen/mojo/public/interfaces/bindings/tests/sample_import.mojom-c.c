...
struct MojomPointerTableStructEntry imported_Point__PointerTable[];
struct MojomPointerTableStructEntry imported_ImportedInterface_DoSomething_Request__PointerTable[];
