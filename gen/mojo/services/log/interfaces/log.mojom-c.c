...
#include "mojo/services/log/interfaces/log.mojom-c.h"
...
struct MojomPointerTableStructEntry mojo_log_Log_AddEntry_Request__PointerTable[];
// Declarations for union type tables.
// Array type entry definitions.
// Struct type table definitions.
struct MojomPointerTableStructEntry mojo_log_Log_AddEntry_Request__PointerTable[] = {
  {
    mojo_log_Entry__PointerTable, 0, 0,
