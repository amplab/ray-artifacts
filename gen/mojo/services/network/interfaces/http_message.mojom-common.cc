...
mojo::internal::ValidationError HttpRequest_Data::Validate(
  ...
  if (!object->url.offset) {
    MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err) <<
        "null url field in HttpRequest struct";
    return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
  }
...
mojo::internal::ValidationError Serialize_(
  ...
  if (input) {
    ...
    if (!result->url.ptr) {
      MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER, "null url in HttpRequest struct");
      return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
    }
    {
      const mojo::internal::ArrayValidateParams headers_validate_params(
