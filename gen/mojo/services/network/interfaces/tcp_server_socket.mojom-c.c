...
struct MojomPointerTableStructEntry mojo_TCPServerSocket_Accept_Request__PointerTable[];
struct MojomPointerTableStructEntry mojo_TCPServerSocket_Accept_Response__PointerTable[];
