...
// static
mojo::internal::ValidationError ServiceProvider_ConnectToService_Params_Data::Validate(
    const void* data,
  ...
  if (!object->interface_name.offset) {
    MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err) <<
        "null interface_name field in ServiceProvider_ConnectToService_Params struct";
...
mojo::internal::ValidationError ServiceProviderRequestValidator::Validate(
  ...
  if (mojo::internal::ControlMessageHandler::IsControlMessage(message)) {
    ...
    if (retval != mojo::internal::ValidationError::NONE) {
      MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err)
        << "request validation error for interface 'ServiceProvider', "
  ...
  switch (method_ordinal) {
    case internal::ServiceProvider_Base::MessageOrdinals::ConnectToService: {
      ...
      retval = mojo::internal::ValidateMessagePayload<
                 internal::ServiceProvider_ConnectToService_Params_Data>(
                    message, err); 
      if (retval != mojo::internal::ValidationError::NONE) {
         MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err)
            << "request validation error for interface 'ServiceProvider', "
...
const uint32_t internal::ServiceProvider_Base::Version_;
...
// static
ServiceProvider_ConnectToService_ParamsPtr ServiceProvider_ConnectToService_Params::New() {
  ServiceProvider_ConnectToService_ParamsPtr rv;
  mojo::internal::StructHelper<ServiceProvider_ConnectToService_Params>::Initialize(&rv);
  return rv;
}

ServiceProvider_ConnectToService_Params::ServiceProvider_ConnectToService_Params()
    : interface_name(),
      pipe() {
}
...
bool ServiceProvider_ConnectToService_Params::Equals(const ServiceProvider_ConnectToService_Params& other) const {
...
size_t ServiceProvider_ConnectToService_Params::GetSerializedSize() const {
  return GetSerializedSize_(*this);
}

bool ServiceProvider_ConnectToService_Params::Serialize(void* buf,
                                size_t buf_size,
  ...
  internal::ServiceProvider_ConnectToService_Params_Data* output_ptr;
...
bool ServiceProvider_ConnectToService_Params::Deserialize(void* buf, size_t buf_size) {
  MOJO_DCHECK(buf);
  ...
  mojo::internal::ValidationError err =
      internal::ServiceProvider_ConnectToService_Params_Data::Validate(buf, &checker, err_str);
  if (err != mojo::internal::ValidationError::NONE) {
...
// immutable.
void ServiceProvider_ConnectToService_Params::DeserializeWithoutValidation(void* buf) {
  MOJO_DCHECK(buf);

  internal::ServiceProvider_ConnectToService_Params_Data* input =
      static_cast<internal::ServiceProvider_ConnectToService_Params_Data*>(buf);
  std::vector<mojo::Handle> handles;
...
mojo::internal::ValidationError Serialize_(
  ...
  if (input) {
    internal::ServiceProvider_ConnectToService_Params_Data* result =
        internal::ServiceProvider_ConnectToService_Params_Data::New(buf);
    SerializeString_(input->interface_name, buf, &result->interface_name.ptr);
    if (!result->interface_name.ptr) {
      MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER, "null interface_name in ServiceProvider_ConnectToService_Params struct");
      return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
    }
    result->pipe = input->pipe.release();
    if (!result->pipe.is_valid()) {
      MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(mojo::internal::ValidationError::UNEXPECTED_INVALID_HANDLE, "invalid pipe in ServiceProvider_ConnectToService_Params struct");
      return mojo::internal::ValidationError::UNEXPECTED_INVALID_HANDLE;
    }
    *output = result;
  } else {
...
void Deserialize_(internal::ServiceProvider_ConnectToService_Params_Data* input,
                  ServiceProvider_ConnectToService_Params* result) {
  if (input) {
    do {
