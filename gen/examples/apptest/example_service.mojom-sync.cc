...
#include "examples/apptest/example_service.mojom-sync.h"
...
ExampleService_SynchronousProxy::ExampleService_SynchronousProxy(
...
bool ExampleService_SynchronousProxy::Ping(uint16_t in_ping_value, uint16_t* out_pong_value) {
  size_t size = sizeof(internal::ExampleService_Ping_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::ExampleService_Base::MessageOrdinals::Ping);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::ExampleService_Ping_Params_Data* out_params =
  ...
  internal::ExampleService_Ping_ResponseParams_Data*
      response_params = reinterpret_cast<internal::ExampleService_Ping_ResponseParams_Data*>(
  ...
  do {
    ...
    (*out_pong_value) = response_params->pong_value;
  } while (false);
  return true;
}
}  // namespace mojo
