...
EchoService_SynchronousProxy::EchoService_SynchronousProxy(
...
bool EchoService_SynchronousProxy::EchoString(const mojo::String& in_value, mojo::String* out_value) {
  size_t size = sizeof(internal::EchoService_EchoString_Params_Data);
  size += GetSerializedSize_(in_value);

  auto msg_name = static_cast<uint32_t>(internal::EchoService_Base::MessageOrdinals::EchoString);
  mojo::RequestMessageBuilder builder(msg_name, size);

  internal::EchoService_EchoString_Params_Data* out_params =
  ...
  internal::EchoService_EchoString_ResponseParams_Data*
      response_params = reinterpret_cast<internal::EchoService_EchoString_ResponseParams_Data*>(
...
bool EchoService_SynchronousProxy::Quit() const  {
  size_t size = sizeof(internal::EchoService_Quit_Params_Data);

  auto msg_name = static_cast<uint32_t>(internal::EchoService_Base::MessageOrdinals::Quit);
  mojo::MessageBuilder builder(msg_name, size);

  internal::EchoService_Quit_Params_Data* out_params =
