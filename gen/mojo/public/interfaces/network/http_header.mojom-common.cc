...
// static
mojo::internal::ValidationError HttpHeader_Data::Validate(
    const void* data,
  ...
  if (!object->name.offset) {
    MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err) <<
        "null name field in HttpHeader struct";
  ...
  if (!object->value.offset) {
    MOJO_INTERNAL_DEBUG_SET_ERROR_MSG(err) <<
        "null value field in HttpHeader struct";
    return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
  }
...
size_t HttpHeader::GetSerializedSize() const {
  return GetSerializedSize_(*this);
}

bool HttpHeader::Serialize(void* buf,
                                size_t buf_size,
  ...
  internal::HttpHeader_Data* output_ptr;
...
bool HttpHeader::Deserialize(void* buf, size_t buf_size) {
  MOJO_DCHECK(buf);
  ...
  mojo::internal::ValidationError err =
      internal::HttpHeader_Data::Validate(buf, &checker, err_str);
  if (err != mojo::internal::ValidationError::NONE) {
...
// immutable.
void HttpHeader::DeserializeWithoutValidation(void* buf) {
  MOJO_DCHECK(buf);

  internal::HttpHeader_Data* input =
      static_cast<internal::HttpHeader_Data*>(buf);
  std::vector<mojo::Handle> handles;
...
mojo::internal::ValidationError Serialize_(
  ...
  if (input) {
    ...
    if (!result->name.ptr) {
      MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER, "null name in HttpHeader struct");
      return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
    }
    SerializeString_(input->value, buf, &result->value.ptr);
    if (!result->value.ptr) {
      MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER, "null value in HttpHeader struct");
      return mojo::internal::ValidationError::UNEXPECTED_NULL_POINTER;
    }
    *output = result;
  } else {
